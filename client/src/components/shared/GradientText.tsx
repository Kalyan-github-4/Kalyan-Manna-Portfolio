...
export default function GradientText({
  ...
  return (
    <motion.span
      className={`relative inline-flex max-w-fit items-center justify-center overflow-hidden transition-shadow duration-500 ${showBorder ? "rounded-[1.25rem] px-2 py-1 backdrop-blur" : ""
        } ${className}`}
    ...
    >
      {showBorder && (
        ...
        >
          <span
            className="absolute rounded-[1.25rem] bg-black -z-10"
            style={{
              width: "calc(100% - 2px)",
              height: "calc(100% - 2px)",
              left: "50%",
