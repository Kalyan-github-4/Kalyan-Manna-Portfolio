    ...
    <div className="relative mx-auto flex w-48 flex-col items-center lg:mx-0">
      ...
      <div className="relative h-48 w-48">
        ...
        <img
          ...
          className="relative z-10 h-48 w-48 rounded-full object-cover p-4 transition-all duration-500 hover:scale-105"
        />
      ...
      <div className="absolute -bottom-4 left-1/2 inline-flex -translate-x-1/2 items-center gap-2 rounded-full border border-violet-400/20 bg-black/70 px-4 py-2 whitespace-nowrap backdrop-blur-md">
