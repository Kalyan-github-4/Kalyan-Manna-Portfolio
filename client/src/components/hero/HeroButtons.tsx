		...
		<div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
			...
			>
				...
				>
					...
					<span className="relative z-10 ml-2 flex h-10 w-10 items-center justify-center rounded-full bg-white text-slate-900 transition-transform duration-500 ease-out group-hover:translate-x-1">
						<ArrowRight size={14} />
					</span>
				</button>
			</ContactDialog>
			...
			>
				<span className="relative flex h-5 w-5 items-center justify-center">
					...
					<Check
						size={18}
						className={`absolute text-green-400 transition-all duration-300 ${
							copied
								? "scale-100 rotate-0 opacity-100"
								: "scale-0 -rotate-90 opacity-0"
						}`}
