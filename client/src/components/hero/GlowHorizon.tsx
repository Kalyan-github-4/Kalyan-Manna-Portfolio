...
export default function GlowHorizon({ className = '' }: GlowHorizonProps) {
  return (
    ...
    >
      <div className="glow-horizon-haze absolute left-1/2 top-[56%] h-[34vh] w-[84vw] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,rgba(42,26,77,0.62)_0%,rgba(28,18,52,0.36)_20%,rgba(0,0,0,0)_72%)] opacity-90 blur-[110px]" />

      <div
        className="glow-horizon-core absolute left-1/2 top-[67%] h-[2250px] w-[2250px] -translate-x-1/2 rounded-full border-t border-white/90 opacity-95"
        style={{
          boxShadow:
      ...
      <div
        className="glow-horizon-core absolute left-1/2 top-[68%] h-[2300px] w-[2300px] -translate-x-1/2 rounded-full border-t border-white/50 opacity-60 blur-[16px]"
        style={{
          boxShadow:
      ...
      <div className="glow-horizon-haze absolute left-1/2 top-[47%] h-[28vh] w-[76vw] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,rgba(42,26,77,0.7)_0%,rgba(42,26,77,0.42)_18%,rgba(0,0,0,0)_72%)] blur-[120px]" />
